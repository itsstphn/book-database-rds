...
if (!fs.existsSync("D:/book-database")) {
  console.log("exists");
  fs.mkdir("D:/book-database", (error) => {
...
app.put("/rename-file-image", (req, res) => {
  ...
  fs.rename(
    `D:/book-database/${originalControlNumber}.jpg`,
    `D:/book-database/${ctrl_number}.jpg`,
    (err) => {
...
app.delete("/delete-img/:originalControlNumber/:ctrl", (req, res) => {
  ...
  fs.unlink(
    `D:/book-database/${req.params.originalControlNumber}.jpg`,
    (err) => {
      return res.json(err);
    }
  );
...
app.use(express.static("D:/book-database"));
...
app.delete("/books/:id", (req, res) => {
  ...
  fs.unlink(`D:/book-database/${bookId}.jpg`, (err) => {
    return res.json(err);
  });
});
